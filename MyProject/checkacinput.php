...
$flag = 0;
	...
	if($acecode == NULL and $acename == NULL and $acemail != NULL)
	{
		...
		{
			echo "No such employee exists<br>";
			$flag = 1;
			$acemail = NULL;
		}
		else
		{
			echo 'Conflicting values found in Table "empmaster".<br>';
			$acemail = NULL;
		}
	}
	...
	{
		echo "Input a value for Actionee Employee Details<br>";
		$flag = 1;
	}
	...
	else 
	{
		...
		$acename=NULL;
		$acemail=NULL;
		echo "Input only one value of Task Actionee<br>";
		$flag = 1;
	}
